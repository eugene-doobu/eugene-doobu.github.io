...
### 핵심 특징
1. **1인 개발 스튜디오**: '우리', '팀' 같은 표현 사용 금지
2. **빠른 학습**: 새로운 기술을 빠르게 배우는 능력
3. **기술 적용**: 배운 기술을 게임에 바로 적용
4. **장난스러운 톤**: "간식주세요", "^오^" 같은 가벼운 분위기

### 강조할 점
- ✅ 빠른 학습 능력 (새로운 기술을 빠르게 익힘)
- ✅ 기술 적용력 (배운 걸 게임에 바로 적용)
- ✅ 빠른 프로토타이핑과 실험 정신
- ✅ 가볍고 재미있는 분위기

### 피해야 할 표현
- ❌ "우리", "팀", "함께" 등 복수 표현
- ❌ "게임성에 대한 새로운 아이디어" (기획력보다 기술력 강조)
- ❌ "게임에 대한 열정" (너무 진지함)
- ❌ "감동을 주는 경험" (과장된 표현)
- ❌ 구체적인 기술명 나열 (Unity, WebGPU 등) → 각 게임 설명에서만 언급

### 톤 & 매너
- 약간 장난스럽고 가벼운 톤
- 기술은 추상적으로 표현 ("최신 기술", "새로운 기술")
- 구체적인 기술명은 각 게임 설명에서만
- 자신감 있지만 겸손한 태도
- "해봤어요", "만들어봤어요" 같은 편안한 어조

### 메시징 전략
- **Hero/About**: 추상적 ("새로운 기술", "빠른 학습")
- **게임 섹션**: 프로페셔널하게 ("게임 목록", "Games") - 포트폴리오 느낌 제거
- **게임 설명**: 구체적 (WebGPU, Unity VFX Graph 등)
- 플레이어는 스튜디오의 학습 능력을 보고, 각 게임에서 실제 적용된 기술을 확인

### 주의사항
- ❌ "만들어본", "실험 겸", "시도해본" 같은 가벼운 표현
- ✅ 게임 회사처럼 당당하게 게임을 소개
- 이것은 포트폴리오가 아닌 **게임 스튜디오의 공식 홍보 페이지**
